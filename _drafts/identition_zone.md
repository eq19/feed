...
```note
In the matrix pictured below, we list the first 24 elements of our domain, take their squares, calculate the modulo 90 congruence and digital roots of each square, and display the digital root factorization dyad for each square (and map their collective bilateral 9 sum symmetry). _([PrimesDemystified]())_
```

![collective bilateral 9 sum symmetry](https://user-images.githubusercontent.com/8466209/200229388-03811f48-2492-4845-b15f-85259cd93717.png)
...
By the above tabulation, here you can see that _[the layout](https://github.com/eq19/feed/tree/v2/_layouts)_ of our home page refers to the four (4) partitions of ∆1 i.e. id: 1-18, id: 19-30, id: 31-36, and id: 37-102.
...
[![114 Nodes](https://user-images.githubusercontent.com/36441664/262341222-6c71005e-2f44-45d9-ac42-b1464c045a45.png)](https://www.eq19.com/multiplication/#parsering-structure)

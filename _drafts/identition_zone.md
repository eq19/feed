...
We show the explicit one-to-one correspondence between Lorentz irreps and field variables, leading to an ``adynkrafield'' formalism in which the traditional $\theta$-monomials are replaced by Young Tableaux. _([Higher-Dimensional Supergravity](https://www.yangruihu.com/susy))_
```

...
By taking the correlation of these 11 partitions with the logical sequence of numbers we found a ***[linkage to the powers of 10 and Fibonaci sequence](https://www.eq19.com/addition/#structure-minor-hexagons)***. This behaviour finaly brings us to a suggestion that the dimension in string theory are linked with the prime distribution.
...
By the above tabulation, here you can see that _[the layout](https://github.com/eq19/feed/tree/v2/_layouts)_ of our home page refers to the configuration of ∆1 i.e. id: 1-18, id: 19-30, id: 31-36, and id: 37-102.

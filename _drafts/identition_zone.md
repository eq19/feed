...
Further observation on these partitions with the logical sequence of numbers we finaly found a ***[linkage to the powers of 10](https://www.eq19.com/addition/#structure-minor-hexagons)***.
```note

...
- An ***[adinkra](https://hepthools.github.io/Data/)*** is a graph-theoretic representation of space–time supersymmetry. Minimal four-color valise adinkras have been extensively studied due to their relations to minimal 4D, N=1 supermultiplets. Valise adinkras, although an important subclass, do not encode all the information present when a 4D supermultiplet is reduced to 1D

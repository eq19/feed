...
The function of _[Euler Identity](https://www.eq19.com/#eulers-identity)_ brings the three (3) operations of ***addition, multiplication*** and ***exponentiation***. By the _[exponentiation zones](https://www.eq19.com/exponentiation/#subclasses-of-partition)_we have shown that it is related to `π = 3.1415…`, the fundamental ***circle constant***. So it is hidden in the imajinary part.

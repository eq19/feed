...
- An ***[adinkra](https://github.com/eq19/feed/files/13248983/2110.01665.pdf)*** is a graph-theoretic representation of space–time supersymmetry. Valise adinkras, although an important subclass, do not encode all the information present when a 4D supermultiplet is reduced to 1D. We extend this to [non-valise adinkras](https://github.com/HEPTHools/Adinkra), via [Python code](https://github.com/eq19/feed/files/13228760/1904.01738.pdf), providing a complete _[eigenvalue classification](https://www.eq19.com/multiplication/#elementary-structure)_ of ***node-lifting***.

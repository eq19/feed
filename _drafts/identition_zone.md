...
Since we are discussing about prime distribution then this 18's structure will also cover the further scheme that is s inherited from the above 37 files. We call this arrangement as ***Δ(19 vs 18) Scenario*** where the [zeta function](https://www.eq19.com/#zeta-function) stands as the basic algorithm.

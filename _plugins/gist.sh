...
mv -f /tmp/workdir/file1.md /tmp/workdir/addition/README.md

gh gist clone 4ffc4d02579d5cfd336a553c6da2f267 /tmp/workdir/multiplication
mv -f /tmp/workdir/file2.md /tmp/workdir/multiplication/README.md

gh gist clone bbfac33187aae966e2faedf253f7b703 /tmp/workdir/exponentiation
mv -f /tmp/workdir/file3.md /tmp/workdir/exponentiation/README.md
...
mv -f /tmp/workdir/file4.md /tmp/workdir/identition/README.md
...
mv -f /tmp/workdir/file5.md /tmp/workdir/identition/folder12/README.md
